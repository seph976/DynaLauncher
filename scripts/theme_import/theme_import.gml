...
function theme_import(){
	...
	sprite_replace(spr_addgame,_loc + "addgame_button.png",0,0,0,sprite_get_width(spr_addgame) / 2,sprite_get_height(spr_addgame) / 2)
	sprite_replace(spr_allapps,_loc + "allapps_button.png",0,0,0,sprite_get_width(spr_allapps) / 2,sprite_get_height(spr_allapps) / 2)
	sprite_replace(spr_news,_loc + "news_button.png",0,0,0,sprite_get_width(spr_news) / 2,sprite_get_height(spr_news) / 2)
	sprite_replace(spr_settings,_loc + "settings_button.png",0,0,0,sprite_get_width(spr_settings) / 2,sprite_get_height(spr_settings) / 2)
	sprite_replace(spr_shop,_loc + "shop_button.png",0,0,0,sprite_get_width(spr_shop) / 2,sprite_get_height(spr_shop) / 2)
