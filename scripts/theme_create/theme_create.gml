...
function theme_create(){
	...
	ini_write_string("Gameinfo","Name X",global.Info_Name_x)
	ini_write_string("Gameinfo","Name Y",global.Info_Name_y)
	ini_write_string("Gameinfo","Name Alignment",global.Info_Name_ha)
	ini_write_string("Gameinfo","Developer X",global.Info_Dev_x)
	ini_write_string("Gameinfo","Developer Y",global.Info_Dev_y)
	ini_write_string("Gameinfo","Developer Alignment",global.Info_Dev_ha)
	ini_write_string("Gameinfo","Date X",global.Info_Date_x)
	ini_write_string("Gameinfo","Date Y",global.Info_Date_y)
	ini_write_string("Gameinfo","Date Alignment",global.Info_Date_ha)
	ini_close()
}